...
public class Lvl3Manager : MonoBehaviour
{
    ...
    void GenerateConditions()
    {
        ...
        {
            DoorOpenInfo.text =
                $"<color=#93AF48>√Î‡‚Ì‡ˇ ‰‚Â¸:</color> T = {mainTargetTemp}∞C, À1 = {mainTargetColor}, À2 = {otherTargetColor}\n" +
                $"<color=#93AF48>ÀËÙÚ 1:</color> T = {elevatorTargetTemp}∞C " +
                $"<color=#93AF48>ÀËÙÚ 2:</color> À1 = {elevator2TargetColor}\n" +
                $"<color=#93AF48>œÎ‡ÚÙÓÏ‡:</color> À2 = {platformTargetColor}";
        }
    }
