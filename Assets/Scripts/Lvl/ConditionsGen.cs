...
public class ConditionsGen : MonoBehaviour
{
    ...
    void GenerateConditions()
    {
        ...
        {
            DoorOpenInfo.text = $"<color=#93AF48>√Î‡‚Ì‡ˇ:</color> T = {mainTargetTemp}∞C, ˆ‚ÂÚ = {mainTargetColor}\n" +
                                $"<color=#93AF48>ŒÒÚ‡Î¸Ì˚Â:</color> T = {otherTargetTemp}∞C, ˆ‚ÂÚ = {otherTargetColor}";
        }
    }
